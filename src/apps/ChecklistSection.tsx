...
import { SectionData, ItemData, SystemUser } from "./types";
...
export default function ChecklistSection({
  ...
  const handleItemDrop = async (targetId: string, targetGroup: "incomplete" | "complete") => {
    ...
    if (dragGroup === targetGroup) {
      ...
      // Dragging between groups (e.g., incomplete to complete) — toggle complete state
      // handled by the checkbox; skip cross-group DnD
    }
